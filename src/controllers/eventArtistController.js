...
const eventArtistController = {
  getAllEventArtists: async (req, res) => {
    try {
  ...
  getArtistsByEventId: async (req, res) => {
  ...
  createEventArtist: async (req, res) => {
  ...
  deleteEventArtist: async (req, res) => {
    const { id } = req.params;
    try {
...
export default eventArtistController;
